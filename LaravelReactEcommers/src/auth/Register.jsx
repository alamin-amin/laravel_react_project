                                    ...
                                    <div className="card-body">
                                        <form>
                                            ...
                                            <div className="row mb-3">
                                                <div className="col-md-6">
                                                    <div className="form-floating mb-3 mb-md-0">
                                                        <input className="form-control" id="inputPassword" type="password" placeholder="Create Link password" />
                                            ...
                                            <div className="mt-4 mb-0">
                                                <div className="d-grid"><Link className="btn btn-primary btn-block" to="login.html">Create Account</Link></div>
                                            </div>
                                        </form>
                                    </div>
